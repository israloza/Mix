...
@section('content')
    <h1 class="bg-success text-white text-center">Modalidades Entregas</h1>
    <div class="row">
        <div class="col"><a class="bg-success text-white" href="{{url("ModalidadesEntrega/create")}}">Agregar</a></div>
    </div>
    <div class="row">
        <div class="col">
            <table class="table">

...
@section('content')
    ...
    <div class="row">
        ...
        <ul class="nav justify-content-center">
            ...
            <li class="nav-item"><a href="#!" class="nav-link text-black-50">Login</a></li>
            <li class="nav-item"><a href="#!" class="nav-link text-black-50">Informacion Solicitada</a></li>
            <li class="nav-item"><a href="#!" class="nav-link text-black-50">Sujetos Obligados</a></li>
            ...
            <li class="nav-item"><a href="#!" class="nav-link text-black-50">Modalidades otros tipos</a></li>
        </ul>
        </div>
    </div>

...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row">
        <div class="col"><a class="btn-success" href="<?php echo e(url("Solicitudes")); ?>">Volver</a></div>
    </div>
    <div class="row">
        <div class="col-4 offset-4">
            <form method="post" action="<?php echo e(url("Solicitudes")); ?>">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('Template.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/Laravel/Protected_File/resources/views/Solicitudes/create.blade.php ENDPATH**/ ?>